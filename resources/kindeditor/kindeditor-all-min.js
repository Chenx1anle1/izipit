...
(function(b, d) {
    ...
    function h(a, c) {
        if (f(a))
            ...
            for (g in a)
                if (a.hasOwnProperty(g) && c.call(a[g], g, a[g]) === !1)
                    break
    }
    function m(a) {
        return a.replace(/(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g, "")
    ...
    function z(a, c) {
        ...
        h(b, function(a, c) {
            if (t = /^(\d+)\.\.(\d+)$/.exec(c))
                for (var b = parseInt(t[1], 10); b <= parseInt(t[2], 10); b++)
                    g[b.toString()] = !0;
            else
                g[c] = !0
        });
        ...
        if (c && c.indexOf(",") >= 0)
            ...
            if (b)
                if (c === d)
                    ...
                    if (t && t.length > 0) {
                        g === d ? (C(a, c, t[0]),
                        delete L[b][c]) : (h(t, function(a, c) {
                            a > 0 && c === g && t.splice(a, 1)
                        }),
                        t.length == 1 && (C(a, c, t[0]),
                        delete L[b][c]));
                        var k = 0;
                        h(L[b], function() {
                            k++
    ...
    function $(a, c, g) {
        ...
        E(a, "keydown", function(b) {
            b.ctrlKey && b.which == c && !b.shiftKey && !b.altKey && (g.call(a),
            b.stop())
        })
    }
    function M(a) {
    ...
    function H(a, c, g, b, d) {
        ...
        var g = g || ""
          ...
          , w = {};
        c && (h(c, function(a, c) {
            for (var g = a.split(","), b = 0, d = g.length; b < d; b++)
                w[g[b]] = z(c)
        }),
        w.script || (a = a.replace(/(<(?:script|script\s[^>]*)>)([\s\S]*?)(<\/script>)/ig, "")),
        w.style || (a = a.replace(/(<(?:style|style\s[^>]*)>)([\s\S]*?)(<\/style>)/ig, "")));
        var i = []
          , a = a.replace(/(\s*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>(\s*)/g, function(a, f, n, l, o, j, s) {
            ...
            if (jb[m] && !Ma[m])
                if (b) {
                    ...
                    s = f = "\n";
                    o = 0;
                    for (j = n ? i.length : i.length - 1; o < j; o++)
                        f += d,
                        n || (s += d);
                    l ? i.pop() : n || (s += d)
                } else
                ...
                if (m === "font") {
                    ...
                    h(p, function(a, c) {
                        if (a === "color")
                            v.color = c,
                            delete p[a];
                        a === "size" && (v["font-size"] = k[parseInt(c, 10) - 1] || "",
                        delete p[a]);
                        a === "face" && (v["font-family"] = c,
                        delete p[a]);
                        a === "style" && (q = c)
                    });
                    q && !/;$/.test(q) && (q += ";");
    ...
    function Fa(a, c) {
        ...
        function k(a, c, g) {
            ...
            if (g.getElementsByClassName) {
                ...
                for (w = d.length; k < w; k++)
                    if (i = d[k],
                    i.nodeType == 1)
                        (c = i.className) && (" " + c + " ").indexOf(a) > -1 && t.push(i)
            }
            return t
        }
        function w(a, c, b, d) {
            for (var t = [], b = d.getElementsByTagName(b), V = 0, k = b.length; V < k; V++)
                d = b[V],
        ...
        function i(a, c) {
            ...
            if (e = /#((?:[\w\-]|\\.)+)$/.exec(a))
                ...
                if (g === "id")
                    ...
                    for (var Z, h = 0, l = e.length; h < l; h++)
                        Z = e[h],
        ...
        for (var c = c || document, f = [], l, o = /((?:\\.|[^\s>])+|[\s>])/g; l = o.exec(a); )
            l[1] !== " " && f.push(l[1]);
        l = [];
        if (f.length == 1)
            return i(f[0], c);
    ...
    function Ob(a, c) {
        var g = ja(a)
          , b = p(c)
          , d = "";
        g.getComputedStyle ? (g = g.getComputedStyle(a, null),
        d = g[b] || g.getPropertyValue(c) || a.style[b]) : a.currentStyle && (d = a.currentStyle[b] || a.style[b]);
        return d
    }
    function X(a) {
        a = a || document;
    ...
    function na(a) {
        var a = a || document, c;
        F || Pb || Qa ? (c = X(a).scrollLeft,
        a = X(a).scrollTop) : (c = ja(a).scrollX,
        a = ja(a).scrollY);
        return {
            x: c,
            y: a
    ...
    function Ra(a, c, g) {
        function b(d, t, V) {
            ...
            c && (i = d.cloneNode(!0),
            i = t > 0 ? i.splitText(t) : i,
            V < k && i.splitText(V - t));
            if (g) {
                var w = d;
                t > 0 && (w = d.splitText(t),
                a.setStart(d, t));
                V < k && (d = w.splitText(V - t),
                a.setEnd(d, 0));
                e.push(w)
            }
            return i
        ...
        function k(d, t) {
            for (var m = d.firstChild, s; m; ) {
                ...
                if (h > 0)
                    ...
                    else if (m.nodeType == 3 && (m = m == f.startContainer ? b(m, f.startOffset, m.nodeValue.length) : m == f.endContainer ? b(m, 0, f.endOffset) : b(m, 0, m.nodeValue.length),
                    c))
                        try {
                            t.appendChild(m)
                        } catch (r) {}
        ...
        if (m.nodeType == 3)
            return m = b(m, a.startOffset, a.endOffset),
            c && s.appendChild(m),
            d(),
            c ? s : a;
        k(m, s);
    ...
    function ua(a, c) {
        for (var g = c; g; ) {
            var b = i(g);
            if (b.name == "marquee" || b.name == "select")
                return;
            g = g.parentNode
        }
        try {
    ...
    function mb(a, c) {
        ...
        for (var l = 0, n = k.length; l < n; l++) {
            ...
            if (o.nodeType == 1) {
                ...
                j.isControl() && (s = g.createElement("span"),
                j.after(s),
                r = s,
                e += j.text().replace(/\r\n|\n|\r/g, "").length);
                ua(m, r);
                ...
                o.nodeType == 3 && (h.moveStart("character", o.nodeValue.length),
                e += o.nodeValue.length);
            f < 0 && (w = o)
        }
        if (f < 0 && w.nodeType == 1)
            return {
        ...
        if (f > 0)
            for (; w.nextSibling && w.nodeType == 1; )
                w = w.nextSibling;
        h = a.duplicate();
        ua(h, d);
        ...
        e -= h.text.replace(/\r\n|\n|\r/g, "").length;
        if (f > 0 && w.nodeType == 3)
            for (g = w.previousSibling; g && g.nodeType == 3; )
    ...
    function nb(a, c) {
        ...
        if (a.nodeType == 1 && a.childNodes.length > 0) {
            ...
            if (k.nodeType == 1) {
                var w = i(k), e;
                w.isControl() && (e = g.createElement("span"),
                d ? w.before(e) : w.after(e),
                k = e);
                ua(b, k);
                b.collapse(d);
                e && i(e).remove();
    ...
    function Sa(a) {
        if (!a.nodeName)
            return a.constructor === aa ? a : ob(a);
        return new aa(a)
    }
    function ea(a, c, g) {
        try {
        ...
        c[g])) {
            for (var g = c[g].split(","), c = !1, b = 0, d = g.length; b < d; b++) {
                ...
                var i = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(k)
                  , k = i[2];
                i[1] ? (k = p(k),
                a[0].style[k] && (a[0].style[k] = "")) : a.removeAttr(k)
            }
            c && a.remove(!0)
        }
    }
    ...
    function tb(a) {
        a.nodeName && (a = ia(a),
        a = Sa(a).selectNodeContents(a.body).collapse(!1));
        return new va(a)
    }
    function Xa(a) {
        var c = a.moveEl
    ...
    function db(a) {
        for (var c = document.getElementsByTagName("head")[0] || (da ? document.body : document.documentElement), g = document.createElement("link"), b = zb(R(a, "absolute")), d = i('link[rel="stylesheet"]', c), k = 0, w = d.length; k < w; k++)
            if (zb(R(d[k].href, "absolute")) === b)
                return;
        c.appendChild(g);
        g.href = a;
        g.rel = "stylesheet"
    ...
    function Ha(a, c) {
        if (!a.collapsed) {
            var a = a.cloneRange().up()
              ...
              , b = a.startOffset;
            if (ka || a.isControl())
                if ((g = i(g.childNodes[b])) && g.name == "img" && c(g))
                    return g
        }
    }
    function Sb() {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    for (h(a._contextmenus, function() {
                        if (this.title == "-")
                            b.push(this);
                        else if (this.cond && this.cond() && (b.push(this),
                        this.width && this.width > g))
                            g = this.width
                    }); b.length > 0 && b[0].title == "-"; )
                        b.shift();
                    for (; b.length > 0 && b[b.length - 1].title == "-"; )
                        b.pop();
                    var d = null;
                    h(b, function(a) {
        ...
        if (!(F && b !== "br") && (!la || !(N < 3 && b !== "p")) && !(Qa && N < 9)) {
            ...
            i(g).keydown(function(i) {
                if (!(i.which != 13 || i.shiftKey || i.ctrlKey || i.altKey)) {
                    c.cmd.selection();
                    var e = a(c.cmd.range);
                    e == "marquee" || e == "select" || (b === "br" && !d[e] ? (i.preventDefault(),
                    c.insertHtml("<br />" + (F && N < 9 ? "" : "\u200b"))) : k[e] || ea(g, "formatblock", "<p>"))
                }
            });
            i(g).keyup(function(d) {
                if (!(d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey) && b != "br")
                    if (la) {
                        var d = c.cmd.commonAncestor("p")
                          , t = c.cmd.commonAncestor("a");
                        t && t.text() == "" && (t.remove(!0),
                        c.cmd.range.selectNodeContents(d[0]).collapse(!0),
                        c.cmd.select())
                    } else if (c.cmd.selection(),
                    d = a(c.cmd.range),
                    !(d == "marquee" || d == "select"))
                        if (k[d] || ea(g, "formatblock", "<p>"),
                        d = c.cmd.commonAncestor("div")) {
            ...
            if (g.which == 9)
                ...
                a.afterTab)
                    ...
                    var g = a.cmd
                      , b = g.range;
                    b.shrink();
                    b.collapsed && b.startContainer.nodeType == 1 && (b.insertNode(i("@&nbsp;", c)[0]),
                    g.select());
                    a.insertHtml("&nbsp;&nbsp;&nbsp;&nbsp;")
                }
        })
    ...
    function Eb(a, c) {
        ...
        if (a.length === 0)
            return this;
        g.designMode ? (d = this.cmd.range,
        k = d.createBookmark(!0),
        k.html = b.innerHTML) : k = {
            html: b.innerHTML
        };
        Db(c, k);
        var e = a.pop();
        ha(k.html) === ha(e.html) && a.length > 0 && (e = a.pop());
        g.designMode ? (g.html(e.html),
        e.start && (d.moveToBookmark(e),
        this.select())) : i(b).html(ha(e.html));
        return this
    }
    function Ba(a) {
        function c(a, c) {
        ...
        if (!g.width)
            g.width = b[0].style.width || b.width();
        if (!g.height)
            g.height = b[0].style.height || b.height();
    ...
    if (!b.KindEditor) {
        ...
        i.basePath = function() {
            for (var a = document.getElementsByTagName("script"), c, g = 0, b = a.length; g < b; g++)
                if (c = a[g].src || "",
                /kindeditor[\w\-\.]*\.js/.test(c))
        ...
        i.options = {
            ...
            htmlTags: {
                ...
                embed: ["id", "class", "src", "width", "height", "type", "loop", "allowfullscreen", "autostart", "quality", ".width", ".height", "align", "allowscriptaccess"],
        ...
        A(P, {
            init: function(a) {
                for (var a = f(a) ? a : [a], c = 0, g = 0, b = a.length; g < b; g++)
                    a[g] && (this[g] = a[g].constructor === P ? a[g][0] : a[g],
                    c++);
                this.length = c;
                this.doc = ia(this[0]);
                this.name = Pa(this[0]);
            ...
            attr: function(a, c) {
                ...
                if (typeof a === "object")
                    ...
                    g;
                if (c === d)
                    return c = g.length < 1 ? null : Ea(g[0], a),
                    c === null ? "" : c;
                g.each(function() {
                    Oa(this, a, c)
                });
            ...
            addClass: function(a) {
                this.each(function() {
                    if (!n(a, this.className, " "))
                        this.className = m(this.className + " " + a)
                });
                return this
            },
            removeClass: function(a) {
                this.each(function() {
                    if (n(a, this.className, " "))
                        this.className = m(this.className.replace(RegExp("(^|\\s)" + a + "(\\s|$)"), " "))
                });
                return this
            },
            html: function(a) {
            ...
            children: function() {
                ...
                for (var a = [], c = this[0].firstChild; c; )
                    (c.nodeType != 3 || m(c.nodeValue) !== "") && a.push(c),
                    c = c.nextSibling;
                return new P(a)
            },
            first: function() {
        ...
        A(aa, {
            ...
            commonAncestor: function() {
                ...
                for (var c = a(this.startContainer), b = a(this.endContainer), d = 0, i = c.length, k = b.length, e, f; ++d; )
                    if (e = c[i - d],
                    f = b[k - d],
                    !e || !f || e !== f)
                        break;
            ...
            selectNodeContents: function(a) {
                ...
                c = c.children();
                if (c.length > 0)
                    return this.setStartBefore(c[0]).setEndAfter(c[c.length - 1]);
            ...
            compareBoundaryPoints: function(a, c) {
                ...
                if (Y) {
                    ...
                    if (k === e)
                        return k = f - h,
                        k > 0 ? 1 : k < 0 ? -1 : 0;
                    for (b = e; b && b.parentNode !== k; )
                        b = b.parentNode;
                    if (b)
                        return i(b).index() >= f ? -1 : 1;
                    for (b = k; b && b.parentNode !== e; )
                        b = b.parentNode;
                    if (b)
                        return i(b).index() >= h ? 1 : -1;
                    if ((b = i(e).next()) && b.contains(k))
                        return 1;
                    if ((b = i(k).next()) && b.contains(e))
                        return -1
                } else
            ...
            insertNode: function(a) {
                ...
                c.nodeType == 1 ? (f = c.childNodes[b]) ? (c.insertBefore(a, f),
                c === d && (i += h)) : c.appendChild(a) : c.nodeType == 3 && (b === 0 ? (c.parentNode.insertBefore(a, c),
                c.parentNode === d && (i += h)) : b >= c.nodeValue.length ? c.nextSibling ? c.parentNode.insertBefore(a, c.nextSibling) : c.parentNode.appendChild(a) : (f = b > 0 ? c.splitText(b) : c,
                c.parentNode.insertBefore(a, f),
                c === d && (d = f,
                i -= b)));
                k ? this.setStartBefore(k).setEndAfter(e) : this.selectNode(a);
                if (this.compareBoundaryPoints(oa, this.cloneRange().setEnd(d, i)) >= 1)
                    return this;
            ...
            get: function(a) {
                ...
                if (a && this.isControl())
                    return c = c.body.createControlRange(),
            ...
            down: function() {
                function a(a, b, d) {
                    if (a.nodeType == 1 && (a = i(a).children(),
                    a.length !== 0)) {
                        var k, e, f, h;
                        b > 0 && (k = a.eq(b - 1));
                        b < a.length && (e = a.eq(b));
            ...
            enlarge: function(a) {
                function c(c, d, k) {
                    c = i(c);
                    if (!(c.type == 3 || La[c.name] || !a && c.isBlock()))
                        if (d === 0) {
                            for (; !c.prev(); ) {
                                d = c.parent();
                                if (!d || La[d.name] || !a && d.isBlock())
                                    break;
                                c = d
                            }
            ...
            shrink: function() {
                for (var a, c = this.collapsed; this.startContainer.nodeType == 1 && (a = this.startContainer.childNodes[this.startOffset]) && a.nodeType == 1 && !i(a).isSingle(); )
                    this.setStart(a, 0);
                if (c)
                    return this.collapse(c);
                for (; this.endContainer.nodeType == 1 && this.endOffset > 0 && (a = this.endContainer.childNodes[this.endOffset - 1]) && a.nodeType == 1 && !i(a).isSingle(); )
                    this.setEnd(a, a.childNodes.length);
                return this
            },
            ...
            moveToBookmark: function(a) {
                ...
                b.remove();
                a && a.length > 0 ? (this.setEndBefore(a[0]),
        ...
        A(va, {
            ...
            select: function(a) {
                ...
                if (a && d.nodeType == 1 && b.collapsed) {
                    ...
                    if (ka && (a = d.childNodes,
                    i(d).isInline() || e > 0 && i(a[e - 1]).isInline() || a[e] && i(a[e]).isInline()))
                        b.insertNode(k.createTextNode("\u200b")),
                        l = !0
                }
                if (Y)
                    try {
                    ...
                    c.removeAllRanges(),
                    c.addRange(h),
                    k !== document && (b = i(h.endContainer).pos(),
                    f.scrollTo(b.x, b.y));
                f.focus();
                return this
            },
                ...
                i(a).scan(function(a) {
                    if (!k && a == e.start)
                        ...
                        if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
                            for (var f; (f = c.parent()) && f.isStyle() && f.children().length == 1; )
                                c = f;
                            f = b;
                            f = f.clone(!0);
                            if (c.type == 3)
                                Wa(f).append(c.clone(!1)),
                                c.replaceWith(f);
                            else {
                                for (var a = c, h; (h = c.first()) && h.children().length == 1; )
                                    c = h;
                                h = c.first();
                                for (c = c.doc.createDocumentFragment(); h; )
                                    c.appendChild(h[0]),
                                    h = h.next();
                                h = a.clone(!0);
                                d = Wa(h);
                                for (var l = h, n = !1; f; ) {
                                    for (; l; )
                                        l.name === f.name && (Qb(l, f.attr(), f.css()),
                                        n = !0),
                                        l = l.first();
            ...
            split: function(a, c) {
                ...
                if (l)
                    ...
                    l = k.lastChild,
                    a ? (e.insertNode(k),
                    b.setStartAfter(l).setEndBefore(d)) : (h.appendChild(k),
                    b.setStartBefore(d).setEndBefore(f)),
                    e = d.parentNode,
                    e == b.endContainer && (h = i(d).prev(),
                    k = i(d).next(),
                    h && k && h.type == 3 && k.type == 3 ? b.setEnd(h[0], h[0].nodeValue.length) : a || b.setEnd(b.endContainer, b.endOffset - 1)),
                    e.removeChild(d);
                return this
            },
            remove: function(a) {
                ...
                b.enlarge();
                if (b.startOffset === 0) {
                    for (var d = i(b.startContainer), e; (e = d.parent()) && e.isStyle() && e.children().length == 1; )
                        d = e;
                    b.setStart(d[0], 0);
                ...
                if (b.collapsed) {
                    ...
                    c = b.startContainer;
                    d = b.startOffset;
                    if (d > 0 && (e = i(c.childNodes[d - 1])) && pa(e))
                        e.remove(),
                        b.setStart(c, d - 1);
            ...
            commonNode: function(a) {
                ...
                if (k)
                    return k;
                if (e.nodeType == 1 || d.nodeType == 3 && b === 0)
                    if (d = i(e).prev())
                        return c(d);
                return null
            },
            commonAncestor: function(a) {
                function c(c) {
                    for (; c; ) {
                        if (c.nodeType == 1 && c.tagName.toLowerCase() === a)
                            return c;
                        c = c.parentNode
                    }
                    return null
            ...
            createlink: function(a, c) {
                ...
                k && !e.isControl() && (e.selectNode(k.get()),
                this.select());
                ...
                var k = e.startContainer
                  ...
                  , h = e.endContainer
                  , e = e.endOffset;
                if (k.nodeType == 1 && k === h && f + 1 === e && (e = k.childNodes[f],
            ...
            unlink: function() {
                ...
                if (c.collapsed) {
                    ...
                    b && (c.selectNode(b.get()),
                    this.select());
                    ea(a, "unlink", null);
                    ka && i(c.startContainer).name === "img" && (a = i(c.startContainer).parent(),
                    a.name === "a" && a.remove(!0))
                } else
                    ea(a, "unlink", null);
                return this
        ...
        A(ga, {
            ...
            pos: function(a, c, b) {
                b = q(b, !0);
                if (a !== null && (a = a < 0 ? 0 : o(a),
                this.div.css("left", a),
                b))
                    this.x = a;
                if (c !== null && (c = c < 0 ? 0 : o(c),
                this.div.css("top", c),
                b))
                    this.y = c;
                return this
        ...
        i.widget = Za;
        var $a = "";
        if (J = document.getElementsByTagName("html"))
            $a = J[0].dir;
        A(xa, ga, {
            init: function(a) {
                function c() {
                    ...
                    ka && i(c).click(function(a) {
                        i(a.target).name === "img" && (l.selection(!0),
                        l.range.selectNode(a.target),
                        l.select())
                    });
                    if (F)
                        ...
                        i(c).keydown(function(a) {
                            if (a.which == 8) {
                                l.selection();
                                var c = l.range;
                                c.isControl() && (c.collapse(!0),
                                i(c.startContainer.childNodes[c.startOffset]).remove(),
                                a.preventDefault())
                            }
                        });
                    b.cmd = l;
                    ...
                    c.body.removeAttribute("disabled")) : c.designMode = "on";
            ...
            html: function(a, c) {
                ...
                if (this.designMode) {
                    b = b.body;
                    if (a === d)
                        return a = c ? "<!doctype html><html>" + b.parentNode.innerHTML + "</html>" : b.innerHTML,
        ...
        A(Ga, ga, {
            init: function(a) {
                ...
                function b(a, d) {
                    var g = c(a.target);
                    if (g && !g.hasClass("ke-disabled") && !g.hasClass("ke-selected"))
                        g[d]("ke-on")
                }
                var d = this;
            ...
            enable: function(a) {
                if (a = a.get ? a : this.get(a))
                    a.removeClass("ke-disabled"),
                    a.opacity(1);
                return this
            },
            disable: function(a) {
                if (a = a.get ? a : this.get(a))
                    a.removeClass("ke-selected").addClass("ke-disabled"),
                    a.opacity(0.5);
                return this
            },
        ...
        A(ya, ga, {
            ...
            addItem: function(a) {
                if (a.title === "-")
                    this.div.append(i('<div class="ke-menu-separator"></div>'));
                else {
                    ...
                    d.css("line-height", e));
                    var h;
                    this.centerLineMode && (h = i('<div class="ke-inline-block ke-menu-item-center"></div>'),
                    e && h.css("height", e));
        ...
        A(za, ga, {
            init: function(a) {
                ...
                for (var e = 0; e < c.length; e++)
                    for (var b = a.insertRow(e + 1), i = 0; i < c[e].length; i++)
                        d = b.insertCell(i),
        ...
        A(bb, {
            init: function(a) {
                ...
                var n = [], o;
                for (o in f)
                    n.push('<input type="hidden" name="' + o + '" value="' + f[o] + '" />');
        ...
        i.tabs = function(a) {
            ...
            c.select = function(a) {
                ...
                h(e, function(b, d) {
                    d.unbind();
                    b === a ? (d.addClass("ke-tabs-li-selected"),
                    i(d.data("tab").panel).show("")) : (d.removeClass("ke-tabs-li-selected").removeClass("ke-tabs-li-on").mouseover(function() {
        ...
        Ba.prototype = {
            ...
            create: function() {
                ...
                if (d) {
                    ...
                    c._fullscreenExecuted && (i(document.body).css({
                        height: "",
                        overflow: ""
                    }),
                ...
                i.each(c.items, function(a, b) {
                    b == "|" ? s.push('<span class="ke-inline-block ke-separator"></span>') : b == "/" ? s.push('<div class="ke-hr"></div>') : (s.push('<span class="ke-outline" data-name="' + b + '" title="' + c.lang(b) + '" unselectable="on">'),
                    s.push('<span class="ke-toolbar-icon ke-toolbar-icon-url ke-icon-' + b + '" unselectable="on"></span></span>'))
                });
                var h = c.toolbar = wb({
                    src: h,
                    html: s.join(""),
                  ...
                  , r = c.edit = ub({
                    ...
                    afterCreate: function() {
                        ...
                        if (c._undoStack.length > 0) {
                            ...
                            a.start && (c.html(a.html),
                            r.cmd.range.moveToBookmark(a),
                            c.select())
                        }
                        c.afterCreate();
                ...
                ,
                i(b).bind("resize", c._fullscreenResizeHandler),
                h.select("fullscreen"),
                m.first().css("visibility", "hidden"),
                m.last().css("visibility", "hidden")) : (la && i(b).bind("scroll", function() {
                    c._scrollPos = na()
                }),
                c.resizeType > 0 ? Xa({
                    moveEl: k,
            ...
            resize: function(a, c, b) {
                b = q(b, !0);
                if (a && (/%/.test(a) || (a = l(a),
                a = a < this.minWidth ? this.minWidth : a),
                this.container.css("width", o(a)),
                b))
                    this.width = o(a);
                if (c && (c = l(c),
                editHeight = l(c) - this.toolbar.div.height() - this.statusbar.height(),
            ...
            html: function(a) {
                if (a === d)
                    return this.isCreated ? this.edit.html() : wa(this.srcElement);
            ...
            exec: function(a) {
                ...
                b && (this.updateState(),
                this.addBookmark(!1),
                this.options.afterChange && this.options.afterChange.call(this));
                return this
            },
            insertHtml: function(a, c) {
                if (!this.isCreated)
            ...
            addBookmark: function(a) {
                var a = q(a, !0)
                  ...
                  , b = c.doc.body
                  , d = Ia(b.innerHTML);
                if (a && this._undoStack.length > 0 && Math.abs(d.length - ha(this._undoStack[this._undoStack.length - 1].html).length) < this.minChangeSize)
                    return this;
                c.designMode && !this._firstAddBookmark ? (c = this.cmd.range,
                a = c.createBookmark(!0),
                a.html = Ia(b.innerHTML),
                c.moveToBookmark(a)) : a = {
                    html: d
                };
            ...
            createMenu: function(a) {
                ...
                a.selectedColor !== d ? (a.cls = "ke-colorpicker-" + this.themeType,
                a.noColor = this.lang("noColor"),
                this.menu = xb(a)) : (a.cls = "ke-menu-" + this.themeType,
                a.centerLineMode = !1,
                this.menu = ab(a));
                return this.menu
            },
        ...
        Ab("core", function(a) {
            ...
            c.afterCreate(function() {
                if (c.syncType == "form") {
                    for (var d = a(c.srcElement), g = !1; d = d.parent(); )
                        if (d.name == "form") {
                            g = !0;
                            break
                        }
            ...
            c.clickToolbar("source", function() {
                c.edit.designMode ? (c.toolbar.disableAll(!0),
                c.edit.design(!1),
                c.toolbar.select("source")) : (c.toolbar.disableAll(!1),
                c.edit.design(!0),
                c.toolbar.unselect("source"),
            ...
            c.afterCreate(function() {
                function b() {
                    ...
                    a("span[style]", f).each(function() {
                        a(this).css("white-space") == "nowrap" && a(this).remove(!0)
                    }),
                    a("meta", f).remove());
                    var d = f[0].innerHTML;
                    f.remove();
                    d !== "" && (ka && (d = d.replace(/(<br>)\1/ig, "$1")),
                    c.pasteType === 2 && (d = d.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/ig, ""),
                    /schemas-microsoft-com|worddocument|mso-\w+/i.test(d) ? d = U(d, c.filterMode ? c.htmlTags : a.options.htmlTags) : (d = H(d, c.filterMode ? c.htmlTags : null),
                    d = c.beforeSetHtml(d))),
                    c.pasteType === 1 && (d = d.replace(/&nbsp;/ig, " "),
                    d = d.replace(/\n\s*\n/g, "\n"),
                    d = d.replace(/<br[^>]*>/ig, "\n"),
                    d = d.replace(/<\/p><p[^>]*>/ig, "\n"),
                    d = d.replace(/<[^>]+>/g, ""),
                ...
                a(d.body).bind("paste", function(l) {
                    if (c.pasteType === 0)
                        ...
                        if (F) {
                            ...
                            g.range.selectNodeContents(f[0]),
                            g.select();
                        setTimeout(function() {
                            b();
                            h = !1
            ...
            c.beforeSetHtml(function(a) {
                F && N <= 8 && (a = a.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/ig, function(a) {
                    var b = K(a);
                    if (M(b.style || "").display == "none")
                        return '<div class="ke-display-none" data-ke-input-tag="' + escape(a) + '"></div>';
                    return a
                }));
...
KindEditor.lang({
    ...
    "media.allowfullscreen": "\u662f\u5426\u53ef\u4ee5\u5207\u6362\u5168\u5c4fcxl",
    "media.upload": "\u4e0a\u4f20",
...
KindEditor.plugin("clearhtml", function(b) {
    ...
    d.clickToolbar("clearhtml", function() {
        ...
        var f = d.html()
          ...
          , f = b.formatHtml(f, {
            a: ["href", "target"],
            embed: ["src", "width", "height", "type", "loop", "allowfullscreen", "autostart", "quality", ".width", ".height", "align", "allowscriptaccess"],
          ...
          , j = d.createDialog({
            ...
            yesBtn: {
                ...
                click: function() {
                    ...
                    b.trim(m) === "" ? (alert(f.pleaseInput),
                    e[0].focus()) : d.insertHtml(h).hideDialog().focus()
                }
            }
        })
          , e = b("textarea", j.div);
...
KindEditor.plugin("emoticons", function(b) {
    ...
    d.clickToolbar("emoticons", function() {
        ...
        function m(d, e) {
            ...
            l.cellSpacing = 0;
            l.border = 0;
            for (var n = (d - 1) * r + p, o = 0; o < s; o++)
                for (var m = l.insertRow(o), j = 0; j < v; j++) {
        ...
        var B, G;
        j && (B = b('<div class="ke-preview"></div>').css("right", 0),
        G = b('<img class="ke-preview-img" src="' + f + p + '.gif" />'),
        q.append(B),
        B.append(G));
        var C = m(e, q), u;
        l(e)
    ...
    f.plugin.filemanagerDialog = function(m) {
        ...
        function s(d) {
            ...
            for (var n = d.file_list, m = 0, j = n.length; m < j; m++) {
                ...
                !r.is_dir || r.has_file ? (p.css("cursor", "pointer"),
                q.attr("title", r.filename),
                o(q, d, r, s)) : q.attr("title", h.emptyFolder);
        ...
        function v(f) {
            ...
            for (var n = f.file_list, m = 0, s = n.length; m < s; m++) {
                ...
                !j.is_dir || j.has_file ? (p.css("cursor", "pointer"),
                d(p, j),
                o(p, f, j, v)) : p.attr("title", h.emptyFolder);
                p.append(q);
                ...
                yesBtn: {
                    ...
                    click: function() {
                        var e = b.trim(p.val())
                          , f = r.val()
                          , h = z.val();
                        e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")),
                        p[0].focus()) : /^\d*$/.test(f) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {
                            src: e,
                        ...
                        d.insertHtml(e).hideDialog().focus()) : (alert(d.lang("invalidHeight")),
                        z[0].focus()) : (alert(d.lang("invalidWidth")),
                        r[0].focus())
                    }
                }
            })
            ...
            e ? l.click(function() {
                d.loadPlugin("filemanager", function() {
                    d.plugin.filemanagerDialog({
                        ...
                        dirName: "flash",
                        clickFn: function(e) {
                            d.dialogs.length > 1 && (b('[name="url"]', v).val(e),
                            d.afterSelectFile && d.afterSelectFile.call(d, e),
                            d.hideDialog())
                        }
                    })
                })
...
KindEditor.plugin("image", function(b) {
    ...
    d.plugin.imageDialog = function(f) {
        ...
        for (u in l)
            C.push('<input type="hidden" name="' + u + '" value="' + l[u] + '" />');
        var C = ['<div style="padding:20px;"><div class="tabs"></div><div class="tab1" style="display:none;"><div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' + p.remoteUrl + "</label>", '<input type="text" id="remoteUrl" class="ke-input-text" name="url" value="" style="width:200px;" /> &nbsp;<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + p.viewServer + '" />', '</span></div><div class="ke-dialog-row">', '<label for="remoteWidth" style="width:60px;">' + p.size + "</label>", p.width + ' <input type="text" id="remoteWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> ', p.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> ', '<img class="ke-refresh-btn" src="' + o + 'refresh.png" width="16" height="16" alt="" style="cursor:pointer;" title="' + p.resetSize + '" />', '</div><div class="ke-dialog-row">', '<label style="width:60px;">' + p.align + "</label>", '<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /> <img name="defaultImg" src="' + o + 'align_top.gif" width="23" height="25" alt="" />', ' <input type="radio" name="align" class="ke-inline-block" value="left" /> <img name="leftImg" src="' + o + 'align_left.gif" width="23" height="25" alt="" />', ' <input type="radio" name="align" class="ke-inline-block" value="right" /> <img name="rightImg" src="' + o + 'align_right.gif" width="23" height="25" alt="" />', '</div><div class="ke-dialog-row">', '<label for="remoteTitle" style="width:60px;">' + p.imgTitle + "</label>", '<input type="text" id="remoteTitle" class="ke-input-text" name="title" value="" style="width:200px;" /></div></div><div class="tab2" style="display:none;">', '<iframe name="' + G + '" style="display:none;"></iframe>', '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + G + '" action="' + b.addParam(m, "dir=image") + '">', '<div class="ke-dialog-row">', C.join(""), '<label style="width:60px;">' + p.localUrl + "</label>", '<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:200px;" readonly="true" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + p.upload + '" />', "</div></form></div></div>"].join(""), I = d.createDialog({
            ...
            yesBtn: {
                ...
                click: function() {
                    if (!I.isLoading)
                        if (q && j && H && H.selectedIndex === 1 || !j)
                            U.fileBox.val() == "" ? alert(d.lang("pleaseSelectFile")) : (I.showLoading(d.lang("uploadLoading")),
                            U.submit(),
                            qa.val(""));
                        else {
                            var e = b.trim(T.val())
                            ...
                            e == "http://" || b.invalidUrl(e) ? (alert(d.lang("invalidUrl")),
                            T[0].focus()) : /^\d*$/.test(f) ? /^\d*$/.test(h) ? B.call(d, e, l, f, h, 0, n) : (alert(d.lang("invalidHeight")),
                            K[0].focus()) : (alert(d.lang("invalidWidth")),
                            M[0].focus())
                        }
                }
            },
        ...
        var U = b.uploadbutton({
            ...
            afterUpload: function(f) {
                ...
                if (f.error === 0) {
                    ...
                    v ? (b(".ke-dialog-row #remoteUrl", E).val(h),
                    b(".ke-tabs-li", E)[0].click(),
                    b(".ke-refresh-btn", E).click()) : B.call(d, h, f.title, f.width, f.height, f.border, f.align)
                } else
                    alert(f.message)
            },
            afterError: function(b) {
        ...
        h ? $.click(function() {
            d.loadPlugin("filemanager", function() {
                d.plugin.filemanagerDialog({
                    ...
                    dirName: "image",
                    clickFn: function(e) {
                        d.dialogs.length > 1 && (b('[name="url"]', E).val(e),
                        d.afterSelectFile && d.afterSelectFile.call(d, e),
                        d.hideDialog())
                    }
                })
        ...
        edit: function() {
            ...
            d.plugin.imageDialog({
                ...
                clickFn: function(e, f, h, l, n, o) {
                    b ? (b.attr("src", e),
                    b.attr("data-ke-src", e),
                    b.attr("width", h),
                    b.attr("height", l),
                    b.attr("title", f),
                    b.attr("align", o),
                    b.attr("alt", f)) : d.exec("insertimage", e, f, h, l, n, o);
                    setTimeout(function() {
                        d.hideDialog().focus()
                    }, 0)
                }
        ...
        j ? l.click(function() {
            d.loadPlugin("filemanager", function() {
                d.plugin.filemanagerDialog({
                    ...
                    dirName: "file",
                    clickFn: function(e) {
                        d.dialogs.length > 1 && (b('[name="url"]', z).val(e),
                        d.afterSelectFile && d.afterSelectFile.call(d, e),
                        d.hideDialog())
                    }
                })
...
KindEditor.plugin("link", function(b) {
    ...
    d.plugin.link = {
        edit: function() {
            var f = d.lang("link.")
              ...
              , j = d.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function() {
                        var f = b.trim(e.val());
                        f == "http://" || b.invalidUrl(f) ? (alert(d.lang("invalidUrl")),
                        e[0].focus()) : d.exec("createlink", f, h.val()).hideDialog().focus()
                    }
                }
            }).div
            ...
            d.cmd.selection();
            if (f = d.plugin.getSelectedLink())
                d.cmd.range.selectNode(f[0]),
                d.cmd.select(),
...
KindEditor.plugin("media", function(b) {
    ...
    d.plugin.media = {
        edit: function() {
            var l = ['<div style="padding:20px;"><div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + f.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:160px;" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + f.upload + '" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + f.viewServer + '" />', '</span></div><div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + f.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="550" maxlength="4" /></div><div class="ke-dialog-row">', '<label for="keHeight" style="width:60px;">' + f.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="400" maxlength="4" /></div><div class="ke-dialog-row">', '<label for="keAllowfullscreen">' + f.allowfullscreen + "</label>", '<input type="checkbox" id="keAllowfullscreen" name="allowfullscreen" value="" /><br/>', '<label for="keAutostart">' + f.autostart + "</label>", '<input type="checkbox" id="keAutostart" name="autostart" value="" /> </div></div>'].join("")
              , s = d.createDialog({
                name: "media",
                width: 450,
                height: 230,
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        p[0].focus()) : /^\d*$/.test(f) ? /^\d*$/.test(h) ? (e = b.mediaImg(d.themesPath + "common/blank.gif", {
                            ...
                            width: f,
                            height: h,
                            allowfullscreen: E[0].checked ? "true" : "false",
        ...
        init: function(d) {
            ...
            var h = {
                ...
                upload_error_handler: function(d) {
                    d && d.filestatus == SWFUpload.FILE_STATUS.ERROR && (d = b('div[data-id="' + d.id + '"]', e.bodyDiv).eq(0),
                    j(d, e.options.errorMessage))
                },
                upload_success_handler: function(d, f) {
                    ...
                    l.error !== 0 ? j(h, b.DEBUG ? l.message : e.options.errorMessage) : (d.url = l.url,
                    b(".ke-img", h).attr("src", d.url).attr("data-status", d.filestatus).data("data", l),
                    b(".ke-status > div", h).hide())
                }
            };
...
(function() {
    ...
    SWFUpload.prototype.buildParamString = function() {
        ...
        if (typeof b === "object")
            for (var f in b)
                b.hasOwnProperty(f) && d.push(encodeURIComponent(f.toString()) + "=" + encodeURIComponent(b[f].toString()));
        return d.join("&amp;")
    }
    ;
        ...
        if (b != void 0) {
            for (var e in b.post)
                if (b.post.hasOwnProperty(e)) {
                    j = e;
                    for (var h; (h = d.exec(j)) !== null; )
                        j = j.replace(h[0], String.fromCharCode(parseInt("0x" + h[1], 16)));
                    f[j] = b.post[e]
                }
            b.post = f
        }
    ...
    SWFUpload.prototype.returnUploadStart = function(b) {
        ...
        else if (this.settings.upload_start_handler != void 0)
    ...
    SWFUpload.prototype.debugMessage = function(b) {
        if (this.settings.debug) {
            ...
            if (typeof b === "object" && typeof b.name === "string" && typeof b.message === "string") {
                for (var f in b)
                    b.hasOwnProperty(f) && d.push(f + ": " + b[f]);
                b = d.join("\n") || "";
                d = b.split("\n");
                b = "EXCEPTION: " + d.join("\nEXCEPTION: ")
            }
...
(function() {
    if (typeof SWFUpload === "function")
        ...
        SWFUpload.queue.uploadCompleteHandler = function(b) {
            ...
            if (typeof d === "function" ? d.call(this, b) !== !1 : b.filestatus !== SWFUpload.FILE_STATUS.QUEUED)
                this.getStats().files_queued > 0 && this.queueSettings.queue_cancelled_flag === !1 ? this.startUpload() : (this.queueSettings.queue_cancelled_flag === !1 ? this.queueEvent("queue_complete_handler", [this.queueSettings.queue_upload_count]) : this.queueSettings.queue_cancelled_flag = !1,
                this.queueSettings.queue_upload_count = 0)
        }
})();
KindEditor.plugin("pagebreak", function(b) {
    ...
    d.clickToolbar("pagebreak", function() {
        ...
        d.insertHtml(f + h);
        h !== "" && (h = b("#__kindeditor_tail_tag__", d.edit.doc),
        e.selectNodeContents(h[0]),
        h.removeAttr("id"),
        j.select())
    })
});
...
KindEditor.plugin("quickformat", function(b) {
    ...
    f.clickToolbar("quickformat", function() {
        ...
        for (var e = f.edit.doc, h = f.cmd.range, m = b(e.body).first(), n, o = [], l = [], s = h.createBookmark(!0); m; ) {
            ...
            var v = d(m);
            if (!v || v.name != "img")
                if (j[m.name] ? (m.html(m.html().replace(/^(\s|&nbsp;|\u3000)+/ig, "")),
                m.css("text-indent", "2em")) : l.push(m),
                !n || j[n.name] || j[m.name] && !j[n.name])
                    l.length > 0 && o.push(l),
                    l = [];
            m = n
        }
    ...
    e.plugin.table = {
        prop: function(n) {
                ...
                yesBtn: {
                    ...
                    click: function() {
                        var d = j.val()
                          ...
                          , W = b(C[1]).html() || "";
                        if (d == 0 || !/^\d+$/.test(d))
                            alert(e.lang("invalidRows")),
                            j[0].focus();
                        else if (f == 0 || !/^\d+$/.test(f))
                            alert(e.lang("invalidRows")),
                            m[0].focus();
                        else if (/^\d*$/.test(h))
                            if (/^\d*$/.test(n))
                                if (/^\d*$/.test(O))
                                    if (/^\d*$/.test(Q))
                                        if (/^\d*$/.test(H)) {
                                            ...
                                            alert(e.lang("invalidBorder")),
                                            G[0].focus();
                                    else
                                        alert(e.lang("invalidSpacing")),
                                        A[0].focus();
                                else
                                    alert(e.lang("invalidPadding")),
                                    q[0].focus();
                            else
                                alert(e.lang("invalidHeight")),
                                r[0].focus();
                        else
                            alert(e.lang("invalidWidth")),
                            p[0].focus()
                    }
                }
            }).div
            ...
            if (!n && (u = e.plugin.getSelectedTable())) {
                ...
                n !== void 0 && (I = /^(\d+)((?:px|%)*)$/.exec(n)) ? (p.val(I[1]),
                z.val(I[2])) : p.val("");
                if (o !== void 0 && (I = /^(\d+)((?:px|%)*)$/.exec(o)))
                    r.val(I[1]),
                    D.val(I[2]);
        ...
        cellprop: function() {
              ...
              , n = e.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function() {
                        ...
                        e.hideDialog().focus(),
                        e.cmd.range.moveToBookmark(o),
                        e.cmd.select(),
                        e.addBookmark()) : (alert(e.lang("invalidBorder")),
                        A[0].focus()) : (alert(e.lang("invalidHeight")),
                        j[0].focus()) : (alert(e.lang("invalidWidth")),
                        l[0].focus())
                    }
                }
            }).div
            ...
            (n = /^(\d+)((?:px|%)*)$/.exec(G[0].style.width || G[0].width || "")) ? (l.val(n[1]),
            m.val(n[2])) : l.val("");
            if (n = /^(\d+)((?:px|%)*)$/.exec(C))
                j.val(n[1]),
                p.val(n[2]);
        ...
        rowinsert: function(d) {
            ...
            for (var p = f.insertRow(m), r = 0, z = h.cells.length; r < z; r++) {
                ...
                if (d === 1 && h.cells[r].colSpan > 1)
                    D.colSpan = h.cells[r].colSpan;
                D.innerHTML = b.IE ? "" : "<br />"
            }
            for (h = m; h >= 0; h--)
                if (d = f.rows[h].cells,
                d.length > r) {
                    for (f = j.cellIndex; f >= 0; f--)
                        d[f].rowSpan > 1 && (d[f].rowSpan += 1);
                    break
                }
        ...
        rowmerge: function() {
            ...
            if (!(b.rows.length <= h))
                ...
                f.colSpan === h.colSpan && (f.rowSpan += h.rowSpan,
                d.deleteCell(b),
        ...
        colmerge: function() {
            ...
            if (!(b.cells.length <= f)) {
                var h = b.cells[f];
                d.rowSpan === h.rowSpan && (d.colSpan += h.colSpan,
                b.deleteCell(f),
                e.cmd.range.selectNodeContents(d).collapse(!0),
                e.cmd.select(),
                e.addBookmark())
            }
        },
        ...
        coldelete: function() {
            for (var d = e.plugin.getSelectedTable()[0], f = e.plugin.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0].cellIndex, j = 0, m = d.rows.length; j < m; j++) {
                var p = d.rows[j]
                  , r = p.cells[h];
                r.colSpan > 1 ? (r.colSpan -= 1,
                r.colSpan === 1 && b(r).removeAttr("colSpan")) : p.deleteCell(h);
                r.rowSpan > 1 && (j += r.rowSpan - 1)
            }
            f.cells.length === 0 ? (e.cmd.range.setStartBefore(d).collapse(!0),
            e.cmd.select(),
            b(d).remove()) : e.cmd.selection(!0);
            e.addBookmark()
        },
        rowdelete: function() {
            for (var d = e.plugin.getSelectedTable()[0], f = e.plugin.getSelectedRow()[0], h = e.plugin.getSelectedCell()[0], f = f.rowIndex, h = h.rowSpan - 1; h >= 0; h--)
                d.deleteRow(f + h);
            d.rows.length === 0 ? (e.cmd.range.setStartBefore(d).collapse(!0),
            e.cmd.select(),
            b(d).remove()) : e.cmd.selection(!0);
            e.addBookmark()
        }
