...
{ 
  ...
  { 
    $this->token = isset($options['token'])?$options['token']:'weixin'; 
    $this->appid = isset($options['appid'])?$options['appid']:'wx38fa416b83779cac'; 
    $this->appsecret = isset($options['appsecret'])?$options['appsecret']:'45815174a7be83e54e372e2a3073cc74'; 
