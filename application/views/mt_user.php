	<div class="container top" style="margin-bottom: 100px;">
        <div class="row">
    		<div class="user-details">
                <div class="user-image">
                	<div class="row">
                    	...
                    	<div class="col-xs-6" style="margin-top: 50px;color: #FF5F83">
                            ...
                            <?php if($setting != "") { ?>
                            <a type="button" href="<?php echo base_url('setting') ?>" style="background: #F8F8F8;padding:10px;color:#777777;margin-top:5px" class=" icon-edit icon-large"><label>&nbsp&nbsp&nbsp</label>编辑头像</a>
                            <?php } ?>
                    	</div>
                ...
                <div class="user-info-block" style="background-color: #F8F8F8;">
                    <ul class="navigation">
...
-->		
                        <li class="<?php if($active == 'picture') { ?> active <?php } ?>">
    						<a style="padding: 6px 106px" href="<?php echo base_url('user/picture/' . $username) ?>">图片</a>
                        </li>
                        <li class="<?php if($active == 'collect') { ?> active <?php } ?>">
    						<a style="padding: 6px 106px" href="<?php echo base_url('user/collect/' . $username) ?>">收藏</a>
                        </li>
                        <li class="<?php if($active == 'atten') { ?> active <?php } ?>">
                            <a style="padding: 6px 106px" href="<?php echo base_url('user/atten/' . $username) ?>">关注的用户</a>
                        </li>
                        <li class="<?php if($active == 'follow') { ?> active <?php } ?>">
                            <a style="padding: 6px 106px" href="<?php echo base_url('user/follow/' . $username) ?>">粉丝</a>
                        </li>
                    </ul>
                </div>
