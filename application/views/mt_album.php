		...
		function xixiAlbum() {
			...
			$.getJSON(surl, function(json) {
				...
				$.each(json, function(index, obj) {
					...
					*/
					var col_div = $('<div>');
					col_div.addClass("col-xs-6 col-md-4 col-lg-3 box");
					album.append(col_div);

					var album_div = $('<div style="height:475px">');
					album_div.addClass("album albums-tab left-pro");
					col_div.append(album_div);
					
					var t_div = $('<div>');
					t_div.addClass("t1");
					album_div.append(t_div);

					var show_div = $('<div>');
					show_div.addClass("showArea");
					t_div.append(show_div);
					
					var cover_div = $('<div>');
					cover_div.addClass("album_cover albums-tab-thumb t2");
...
/*给创建者一个连接<a href="<?php echo base_url('user/index/'.$user) ?>"><?php echo $user ?></a>*/
					...
					var cover_a = $('<a>');
					cover_a.addClass('MagicZoom MagicThumb');

					cover_a.attr('href', album_url);
					cover_a.attr('id','zoom1');
					...
					var cover_img = $('<img />');
					cover_img.addClass('all studio main_img');
					...
					//----------------
					var pic001_div = $('<div>');
					pic001_div.addClass("album_picture pull-left sim-anim-2");
					...
					pic001_a.attr('rev',obj.albumPic001);
					...
					//002
					var pic002_div = $('<div>');
					pic002_div.addClass("album_picture pull-left sim-anim-2");
					...
					//003
					var pic003_div = $('<div>');
					pic003_div.addClass("album_picture pull-left sim-anim-2");
